...
{
    uint8_t                 identity[CY_SUPPLICANT_MAX_IDENTITY_LENGTH];  /**<  Username */
    uint8_t                 identity_length;                              /**<  Username length */
    /* in Windows password is UNICODE */
    uint8_t                 password[CY_SUPPLICANT_MAX_PASSWORD_LENGTH];  /**<  Password */
...
typedef struct cy_supplicant_instance_s
{
    ...
    uint8_t                             outer_eap_identity[CY_SUPPLICANT_MAX_IDENTITY_LENGTH];  /**<  Outer EAP identity */
