...
cy_rslt_t supplicant_init_ttls_phase2_handshake(supplicant_workspace_t* workspace)
{
    ...
    supplicant_create_ttls_response_packet( &response_packet, CY_SUPPLICANT_EAP_TYPE_IDENTITY, phase2_state->identity_length, workspace->tls_length_overhead, workspace);
